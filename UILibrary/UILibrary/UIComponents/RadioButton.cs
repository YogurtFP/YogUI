...
namespace YogUI.Code.UIComponents
{
    public class RadioButton : UIComponent
    {
        ...
        public RadioButton(Vector2 position, string text = "RadioButton")
        {
            labelText = text;
            label = new TextDrawer(AssetManager.GetFont("Console"), labelText, position + new Vector2(radius + 5,  -radius * 1.9f), Color.White);
            Position = position;
            base.UIC_Initialize();
        }
