...
namespace YogUI
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            AssetManager.LoadAsset<SpriteFont>("default", "default", Content, GraphicsDevice);

            //Create a new Text Field with position (top-left) at 0, 10. Width 100, height 20 (don't change this to anything else yet),
            //White text, Black background, White border, "Console" font, doing nothing on text enter, and nothing on text changed.
            textField = new TextField(new Vector2(0, 10), 100, 20, Color.White, Color.Black, Color.White, AssetManager.GetFont("Console"), (string s) => { /*Pressed Enter*/ }, (string s) => { /*Text changed*/});
            textField.SetText("TextField");

            //Create a new ListBox at (0, 50), 90 width, 100 height, and doing nothing on Selected Index Changed.
            listBox = new ListBox(new Vector2(0, 50), 90, 100, () => { /*Selected Index Changed*/});
            ...
            //Create a new sliderbar at (150, 150), 100 width, 30 height, 0 minimum value, 200 maximum value, 25% progress.
            sliderBar = new SliderBar(new Vector2(150, 150), 100, 30, 0, 200, 25);

            //Create two new radiobuttons
            radioButton1 = new RadioButton(new Vector2(200, 50), "RadioButton 1");
            radioButton2 = new RadioButton(new Vector2(200, 65), "Radiobutton 2");
            ...
            //Create a new CheckBox at (200, 90).
            checkBox = new CheckBox(new Vector2(200, 90));

            //Create a new ComboBox at (500, 200).
            comboBox = new ComboBox(new Vector2(500, 200), "Combo box option 1", "Combo box option 2", "Combo box option 3");
            ...
            button = new Button(new Vector2(500, 100), "Button", () => { listBox.dataSource.Add(textField.GetText()); });
        }
