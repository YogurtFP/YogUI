...
namespace UnitTests
{
    ...
    /// <summary>
    ///This is a test class for CodeBoundMouseTest and is intended
    ///to contain all CodeBoundMouseTest Unit Tests
    ///</summary>
    [TestClass()]
    public class CodeBoundMouseTest
    {
        ...
        /// <summary>
        ///A test for CodeBoundMouse Constructor
        ///</summary>
        [TestMethod()]
        public void CodeBoundMouseConstructorTest()
        {
            ...
            CodeBoundMouse target = new CodeBoundMouse(a, button, pressing, constant, identifier);
